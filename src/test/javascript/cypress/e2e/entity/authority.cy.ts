...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '2b618fe2-e33b-4761-99eb-161c33d4addc' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('ec6a21fc-7f86-410b-bbe1-9ad02b905ed4');
      cy.get(`[data-cy="name"]`).should('have.value', 'ec6a21fc-7f86-410b-bbe1-9ad02b905ed4');
